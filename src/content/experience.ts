...
export const experiences: ExperienceItem[] = [
  {
    ...
    focus: "프론트엔드 기반이 없는 조직에서 공통 구조와 팀 기준을 처음부터 세우는 일",
    decision: "화면보다 먼저 모노레포, MUI 규칙, 협업 언어를 맞춰 팀이 같은 뼈대 위에서 움직이게 만들고 있습니다.",
    summary: "애드포터의 Admin·Web·App 공통 뼈대와 작업 언어를 정리하는 중입니다.",
    highlights: [
  ...
  },
  {
    ...
    focus: "복합 라이브러리 Admin과 글로벌 LMS를 같은 규칙으로 묶는 일",
    decision: "혼합 UI를 화면별 예외로 풀지 않고 공통 규칙과 CRUD 템플릿으로 묶어 확장 속도를 만들었습니다.",
    summary: "복합 Admin과 글로벌 LMS에서 화면 규칙과 출시 구조를 함께 잡았습니다.",
    highlights: [
  ...
  },
  {
    ...
    focus: "브랜드 감각, 운영 속도, 전환 성과를 동시에 맞추는 일",
    decision: "이벤트 페이지를 개별 산출물이 아니라 템플릿으로 보고 디바이스별 인터랙션 규칙까지 함께 정리했습니다.",
    summary: "운영형 이벤트와 디지털 데모에서 화면 감각과 속도를 같이 다뤘습니다.",
    highlights: [
  ...
  },
  {
    ...
    decision: "운영과 접근성, 마크업 품질을 같이 다루며 이후 구조 설계와 화면 완성도를 받치는 기본기를 만들었습니다.",
    summary: "실무 운영과 웹 표준 퍼블리싱으로 화면 완성도의 기초를 다졌습니다.",
    highlights: [
      "자사몰 구축 및 유지보수",
      "글로벌 자회사 사이트와 도메인 운영",
